...
/* harmony export */   INBOX_FOLDER_ID: () => (/* binding */ INBOX_FOLDER_ID),
...
/* harmony export */ });
const APP_CODE_NAME = 'D';
const APP_NAME =  false || `Telegram Web ${APP_CODE_NAME}`;
const RELEASE_DATETIME = 1747664221566;
const PRODUCTION_HOSTNAME = 'telegram-d-with-bugs-and-bananas.netlify.app';
const PRODUCTION_URL = 'https://telegram-d-with-bugs-and-bananas.netlify.app/';
const WEB_VERSION_BASE = 'https://web.telegram.org/'; // Used to redirect to other versions
const BASE_URL = "https://telegram-d-with-bugs-and-bananas.netlify.app";
...
const INBOX_FOLDER_ID = -2; // Special folder for unread chats
...
//# sourceMappingURL=src_config_ts-src_util_schedulers_ts.39d42049b6f7d7f7a505.js.map